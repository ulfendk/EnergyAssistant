...
{
    private readonly IDbContextFactory<EnergyAssistantContext> ctxFactory;
    ...
    {
        ctxFactory = dbContextFactory ?? throw new ArgumentNullException(nameof(dbContextFactory));
